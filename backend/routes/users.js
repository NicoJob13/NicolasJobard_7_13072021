...
router.get('/myaccount', usersCtrl.getProfile); //Affichage du profil d'un utilisateur
router.put('/modify', usersCtrl.updateUser); //Modification d'un utilisateur
router.delete('/delete', usersCtrl.deleteUser); //Suppression d'un utilisateur
